    ...
    public commands: CommandDefinition[] = [
        {
            ...
            func: async (dataService, context, params) => {
                try {
                    ...
                    return ServiceResponseHelper.error(`Error listing products: ${e.message}`, "STOCK_LIST_ERROR");
                }
            }
        },
        {
            ...
            func: async (dataService, context, params) => {
                try {
                    ...
                    return await (dataService as any).push('products', {
                        code, name, price, quantity, category, is_weight
                    }, context);
                } catch (e: any) {
                    return ServiceResponseHelper.error(`Error adding product: ${e.message}`, "STOCK_ADD_ERROR");
                }
            }
        },
        {
            ...
            func: async (dataService, context, params) => {
                try {
                    ...
                    return ServiceResponseHelper.error(`Error updating stock: ${e.message}`, "STOCK_UPDATE_ERROR");
                }
            }
        },
        {
            ...
            func: async (dataService, context, params) => {
                try {
                    ...
                    return ServiceResponseHelper.error(`Error fetching product: ${e.message}`, "STOCK_GET_ERROR");
                }
            }
        }
    ];
