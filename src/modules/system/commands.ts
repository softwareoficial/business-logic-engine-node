    ...
    public commands: CommandDefinition[] = [
        {
            ...
            func: async (dataService, context, params) => {
                try {
                    ...
                    return ServiceResponseHelper.error(`Error registering client: ${e.message}`, "CLIENT_REG_ERROR");
                }
            }
        },
        {
            ...
            func: async (dataService, context, params) => {
                try {
                    ...
                    if (!allowedPlans.includes(plan)) {
                        return ServiceResponseHelper.error("Invalid plan. Must be 'free', 'pro', or 'enterprise'.", "INVALID_PLAN");
                    }
                    ...
                    return ServiceResponseHelper.error(`Error updating plan: ${e.message}`, "PLAN_UPDATE_ERROR");
                }
            }
        },
        {
            ...
            func: async (dataService, context, params) => {
                try {
                    ...
                    return ServiceResponseHelper.error(`Error listing events: ${e.message}`, "EVENT_LIST_ERROR");
                }
            }
        },
        {
            ...
            func: async (dataService, context, params) => {
                try {
                    ...
                    return ServiceResponseHelper.error(`Error getting stats: ${e.message}`, "EVENT_STATS_ERROR");
                }
            }
        },
        {
            ...
            func: async (dataService, context, params) => {
                try {
                    ...
                    return ServiceResponseHelper.error(`Error getting top errors: ${e.message}`, "EVENT_TOP_ERRORS_ERROR");
                }
            }
        },
        {
            ...
            func: async (dataService, context, params) => {
                try {
                    ...
                    return ServiceResponseHelper.error(`Error clearing events: ${e.message}`, "EVENT_CLEAR_ERROR");
                }
            }
        },
        {
